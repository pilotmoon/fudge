...
var require_main = __commonJS((exports) => {
  var parseWithLocation = function(content, filename, locationKeyName) {
    return _parse(content, filename, locationKeyName);
  };
  var parse = function(content) {
    return _parse(content, null, null);
  };
  var _parse = function(content, filename, locationKeyName) {
  ...
  exports.parse = exports.parseWithLocation = undefined;
...
// src/parsers.ts
var import_fast_plist = __toESM(require_main(), 1);
...
var YAMLException$1 = function(reason, mark) {
  Error.call(this);
...
var Type$1 = function(tag, options) {
  options = options || {};
...
var Schema$1 = function(definition) {
...
var State$1 = function(input, options) {
  this.input = input;
...
var loadAll$1 = function(input, iterator, options) {
...
var load$1 = function(input, options) {
  var documents = loadDocuments(input, options);
...
var dump$1 = function(input, options) {
  options = options || {};
...
function parsePlistObject(plist) {
  try {
    return ZConfigObject.parse(import_fast_plist.parse(plist.replace(/<key>Credits<\/key>\s*<array>[\s\S]*?<\/array>/, "")));
  } catch (e) {
...
function parseYamlObject(yamlSource) {
  try {
    return ZConfigObject.parse(load(yamlSource, {
      schema: JSON_SCHEMA
    }));
  } catch (e) {
    if (e instanceof z.ZodError) {
...
var getPartsAndIndexes = function(string, splitRegex) {
...
var splitAndPrefix = function(string, options) {
...
var lowerCase = function(string, options = { keepSpecialCharacters: true }) {
...
var ZConfigFiles = z.array(z.object({
  name: z.string(),
  contents: z.string()
}));
